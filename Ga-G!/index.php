...
<body>
  <nav class="nav">
    <div class="container">
        <div class="logo">
            <!-- <a href="#">Your Logo</a> -->
            <img src="gagilogo.png" alt="gagi" width = "125px"/> 
        </div>
...
<div class="konten">
    <div><h1 class="judul2">Bergabunglah dengan komunitas yang kamu mau! </h1></div>
    <div class="subkonten2">
        <div>
        ...
        <div>
            ...
            <img src="assets/pic/icon3.png" class="Gkonten3">
        </div>       
